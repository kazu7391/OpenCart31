...
var builder = {
            ...
            if(isDraw) {
                columns.forEach(function (col) {
                    if(container.has('.sub-col-' + col_count + ' .layout-module-info').length) {
                        html += '           <div class="col-md-' + col + ' column-area">';
            ...
            if(isDraw) {
                columns.forEach(function (col) {
                    if(container.has('.main-col-' + col_count + ' .sub-row').length) {
                        html += '<div class="col-md-' + col + ' main-column">';
                        ...
                        html += '                       <a href="javascript:void(0);" onclick="builder.plusSubColumn($(this))" rel="1" class="col-plus"><i class="fa fa-plus-square"></i></a>';
                        html += '                       <span class="count">1</span>';
                        html += '                       <a href="javascript:void(0);" onclick="builder.minusSubColumn($(this))" rel="1" class="col-minus"><i class="fa fa-minus-square"></i></a>';
                        html += '                   </div>';
                        html += '                   <div class="a-group">';
                        html += '                       <a class="a-column-custom" title="' + text_custom_columns + '" onclick="builder.customSubColumns($(this))" href="javascript:void(0);"><i class="fa fa-th-large"></i></a>';
                        html += '                       <a class="a-row-delete" onclick="builder.removeSubRow($(this))" href="javascript:void(0);"><i class="fa fa-times-circle"></i></a>';
                        html += '                   </div>';
                        html += '               </div>';
                        html += '               <input type="hidden" class="sub-cols-format" value="12" />';
                        html += '           </div>';
                        html += '           <div class="sub-row-content row">';
                        html += '               <div class="col-md-12 column-area">';
    ...
    'drawMainRow' : function (row_number) {
        ...
        var html = "";
        html += '<div class="widget-row col-md-12">';
        ...
        html += '               <a href="javascript:void(0);" onclick="builder.plusMainColumn($(this));" rel="1" class="col-plus"><i class="fa fa-plus-square"></i></a>';
        html += '               <span class="count" >1</span>';
        html += '               <a href="javascript:void(0);" onclick="builder.minusMainColumn($(this));" rel="1" class="col-minus"><i class="fa fa-minus-square"></i></a>';
        html += '           </div>';
        html += '           <div class="a-group">';
        html += '               <a class="a-column-custom" onclick="builder.customMainColumns($(this));" href="javascript:void(0);" title="' + text_custom_columns + '"><i class="fa fa-th-large"></i></a>';
        html += '               <a class="a-row-delete" onclick="builder.removeRow($(this));" href="javascript:void(0);"><i class="fa fa-times-circle"></i></a>';
        html += '           </div>';
        html += '       </div>';
        ...
        html += '   <div class="row-content row-'+ row_number +'">' +
            ...
            '                               <a href="javascript:void(0);" onclick="builder.plusSubColumn($(this))" rel="1" class="col-plus"><i class="fa fa-plus-square"></i></a>' +
            '                               <span class="count">1</span>' +
            '                               <a href="javascript:void(0);" onclick="builder.minusSubColumn($(this))" rel="1" class="col-minus"><i class="fa fa-minus-square"></i></a>' +
            '                           </div>' +
            '                           <div class="a-group">' +
            '                               <a class="a-column-custom" onclick="builder.customSubColumns($(this))" href="javascript:void(0);" title="' + text_custom_columns + '"><i class="fa fa-th-large"></i></a>' +
            '                               <a class="a-row-delete" onclick="builder.removeSubRow($(this))" href="javascript:void(0);"><i class="fa fa-times-circle"></i></a>' +
            '                           </div>' +
            '                       </div>' +
            '                       <input type="hidden" class="sub-cols-format" value="12" />' +
            '                   </div>' +
            '                   <div class="sub-row-content row">' +
            '                       <div class="col-md-12 column-area">' +
